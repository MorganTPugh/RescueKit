  ...
  const chapters = [
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-sky-50 border border-sky-100 rounded-2xl p-5 text-stone-700">
            <h3 className="font-bold text-slate-900 text-sm mb-2">A Message of Heartfelt Thanks</h3>
          ...
          <div>
            <h4 className="font-black text-slate-800 text-xs border-b pb-1.5 mb-3">What Fostering Means</h4>
          ...
          <div className="bg-indigo-50 border border-indigo-100 p-4 rounded-xl text-xs text-indigo-900 font-semibold">
            <p className="italic">This handbook is provided as a free resource by RescueKit for rescues, shelters, and foster families everywhere. It is designed to be rescue-agnostic and may be customized with your organization's contact information.</p>
          </div>
        </div>
      ),
    },
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="bg-slate-50 border rounded-2xl p-4">
            <h4 className="font-extrabold text-indigo-700 text-xs mb-3 flex items-center gap-1.5">
              <span className="w-1.5 h-3.5 bg-indigo-600 rounded-sm inline-block"></span>
              Core Responsibilities
            </h4>
            <ul className="space-y-2 text-[11px] font-semibold text-stone-700">
              {[
          ...
          <div className="border border-amber-200 p-4 rounded-xl bg-amber-50/40 space-y-2">
            <h5 className="font-bold text-xs text-amber-950">Medical Costs & Liability</h5>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <div>
            <h4 className="font-bold text-slate-900 text-xs mb-2">Choosing a Foster Area</h4>
            <p className="text-xs text-slate-500 font-semibold mb-2">Select a dedicated area (bathroom, laundry room, kitchen, or a gated corner). Consider:</p>
            <div className="grid grid-cols-1 gap-2 text-[11px] font-semibold text-stone-600">
              {[
            ...
            <div className="mt-2 bg-amber-50 border border-amber-200 p-3 rounded-xl text-[11px] font-semibold text-amber-900">
          ...
          <div className="border border-amber-200 bg-amber-50/50 p-4 rounded-2xl">
            <h4 className="font-extrabold text-amber-950 text-xs mb-2 flex items-center gap-1">
            ...
            <div className="grid grid-cols-2 gap-2 text-[10px] text-stone-700 font-bold border-t border-amber-200/50 pt-2">
          ...
          <div>
            <h4 className="font-bold text-xs text-slate-800 mb-1">Setting Up a Bathroom Zone (Dogs)</h4>
          ...
          <div className="border border-sky-200 bg-sky-50/50 p-4 rounded-2xl space-y-2">
            <h4 className="font-bold text-xs text-sky-950">🐱 Litter Box Setup & Care (Cats)</h4>
            <ul className="space-y-1.5 text-[11px] font-semibold text-stone-600">
              {[
            ...
            <div className="bg-rose-50 border border-rose-200 p-3 rounded-xl text-[11px] font-semibold text-rose-900">
          ...
          <div className="border border-purple-100 bg-purple-50/30 p-4 rounded-xl space-y-2">
            <h4 className="font-bold text-xs text-purple-950">🐱 Setting Up Hiding Spaces (Cats)</h4>
          ...
          <div className="border border-emerald-200 bg-emerald-50/30 p-4 rounded-xl space-y-2">
            <h4 className="font-bold text-xs text-emerald-950">🐱 Recommended Supplies for Cat Fosters</h4>
            <ul className="grid grid-cols-1 gap-1.5 text-[11px] font-semibold text-stone-600">
              {[
          ...
          <div>
            <h4 className="font-bold text-xs text-slate-800 mb-1">Cleaning Supplies to Have Ready</h4>
            <p className="text-xs text-stone-600 font-medium leading-relaxed">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-3">
            <div className="p-4 bg-stone-50 border rounded-xl">
              <h5 className="font-bold text-[11px] text-slate-900 mb-2">What to Expect — These Are Normal</h5>
            ...
            <div className="p-4 bg-emerald-50/60 border border-emerald-100 rounded-xl">
              <h5 className="font-bold text-[11px] text-emerald-950 flex items-center gap-1 mb-2">
          ...
          <div className="space-y-2">
            <h4 className="font-bold text-xs text-slate-800">Bringing Your Foster Home</h4>
          ...
          <div className="bg-sky-50/50 border border-sky-100 p-4 rounded-xl space-y-2">
            <h4 className="font-bold text-xs text-slate-800">Helping Your Foster Decompress</h4>
            <ul className="space-y-1.5 text-[11px] text-stone-600 font-medium">
              {[
          ...
          <div className="bg-indigo-50 border border-indigo-200 p-4 rounded-xl">
            <h4 className="font-bold text-xs text-indigo-950 mb-2">Introducing Foster Dogs to Resident Dogs</h4>
            <ul className="space-y-1.5 text-[11px] text-indigo-900 font-semibold">
              {[
          ...
          <div className="bg-purple-50 border border-purple-100 p-4 rounded-xl">
            <h4 className="font-bold text-xs text-purple-950 mb-2">Introducing Foster Cats to Resident Cats</h4>
            <p className="text-[11px] font-semibold text-stone-600 mb-2">Cats require more patience — they can remain irritable or fearful for weeks.</p>
            <ul className="space-y-1.5 text-[11px] text-purple-900 font-semibold">
              {[
          ...
          <div className="bg-emerald-50 border border-emerald-200 p-3 rounded-xl text-[11px] font-semibold text-emerald-900">
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="p-4 border rounded-2xl bg-sky-50/40">
            <h4 className="font-bold text-xs text-slate-800 mb-2">Introducing the Crate</h4>
          ...
          <div>
            <h4 className="font-bold text-xs text-slate-800 mb-2">Crating Duration Guidelines (Dogs)</h4>
            <p className="text-[11px] font-semibold text-stone-500 mb-2">Never crate beyond the maximum time appropriate for the animal's age:</p>
            ...
            <p className="text-[10px] font-semibold text-slate-500 mt-2 italic">Note: Very young puppies under 9 weeks should not be crated — they cannot yet control their bladder and must eliminate 8–12 times per day.</p>
          </div>

          <div className="bg-indigo-50/50 border border-indigo-100 p-4 rounded-xl space-y-2">
            <h4 className="font-bold text-xs text-indigo-950">Special Crating Considerations</h4>
            <ul className="space-y-1.5 text-[11px] font-semibold text-indigo-900">
          ...
          <div className="grid grid-cols-1 gap-3">
            <div className="p-3 border rounded-xl bg-rose-50/50">
              <h5 className="font-extrabold text-rose-950 text-xs mb-2">When NOT to Use a Crate</h5>
              <ul className="space-y-1 text-[11px] text-rose-900 font-semibold">
                {[
            ...
            <div className="p-3 border rounded-xl bg-slate-50">
              <h5 className="font-bold text-slate-900 text-xs mb-2">Important Crate Rules</h5>
              <ul className="space-y-1 text-[11px] text-stone-600 font-semibold">
                {[
      ...
      content: (
        <div className="space-y-4">
          <div className="p-4 bg-emerald-50 border border-emerald-100 rounded-2xl">
            <h4 className="font-bold text-xs text-emerald-950 mb-2 flex items-center gap-1">
          ...
          <div>
            <h4 className="font-bold text-xs text-slate-800 mb-2">Housetraining</h4>
            <p className="text-[11px] text-stone-500 font-semibold mb-2">Even previously housetrained adult dogs may have accidents in a new home — they need time to learn the new routine.</p>
            <ul className="space-y-1.5 text-[11px] text-stone-600 font-medium">
              {[
            ...
            <div className="mt-2 bg-rose-50 border border-rose-200 p-3 rounded-xl text-[11px] font-semibold text-rose-900">
          ...
          <div className="grid grid-cols-1 gap-3">
            <div className="p-3 border rounded-xl bg-slate-50">
              <h4 className="font-bold text-xs text-slate-800 mb-2">Other House Manners to Work On</h4>
              <ul className="space-y-1.5 text-[11px] text-stone-600 font-semibold">
                {[
            ...
            <div className="p-3 border rounded-xl bg-indigo-50/40">
              <h4 className="font-bold text-xs text-indigo-950 mb-2">Separation Anxiety</h4>
              <ul className="space-y-1.5 text-[11px] text-indigo-900 font-semibold">
                {[
          ...
          <div className="bg-sky-50 border border-sky-100 p-4 rounded-xl space-y-2">
            <h4 className="font-bold text-xs text-sky-950">🐱 Cat Behavior: Scratching</h4>
            <p className="text-[11px] font-semibold text-stone-600 leading-relaxed">
          ...
          <div className="bg-purple-50 border border-purple-100 p-4 rounded-xl space-y-2">
            <h4 className="font-bold text-xs text-purple-950">🐱 Cat Behavior: Counter Jumping</h4>
            <p className="text-[11px] font-semibold text-stone-600 leading-relaxed">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="p-4 border rounded-2xl bg-sky-50/40">
            <h4 className="font-extrabold text-slate-900 text-[11px] mb-3">Feeding Guidelines</h4>
            <ul className="space-y-2 text-[11px] text-stone-600 font-bold leading-relaxed">
              {[
            ...
            <div className="mt-3 bg-emerald-50 rounded-xl p-3 border border-emerald-200 text-[11px] text-emerald-950 font-bold">
          ...
          <div className="bg-rose-50 border border-rose-200 p-4 rounded-xl">
            ...
            <p className="text-[11px] text-rose-800 leading-normal font-semibold mb-3">
            ...
            <div className="grid grid-cols-3 gap-1 px-2 py-1 bg-white/70 rounded-lg text-[9px] text-stone-700 font-black">
      ...
      content: (
        <div className="space-y-4">
          <div className="p-4 bg-amber-50/60 border border-amber-200 rounded-2xl">
            ...
            <div className="grid grid-cols-1 gap-2 text-[11px] font-bold text-stone-700">
            ...
            <p className="text-[11px] font-black text-rose-700 mt-2">
          ...
          <div className="p-4 bg-sky-50 rounded-2xl border">
            <h4 className="font-extrabold text-slate-900 text-xs mb-3">Daily Health Check — Signs of a Healthy Animal</h4>
            <div className="grid grid-cols-1 gap-2 text-[11px] text-stone-600 font-semibold">
              {[
          ...
          <div className="bg-rose-50/60 border border-rose-200 p-4 rounded-xl">
            <h4 className="font-extrabold text-rose-950 text-xs mb-2">Early Warning Signs — Contact Your Rescue</h4>
            <ul className="grid grid-cols-1 gap-1.5 text-[11px] text-rose-950 font-semibold leading-snug">
              {[
            ...
            <div className="mt-3 bg-white/80 border border-rose-200 p-3 rounded-xl text-[11px] font-semibold text-rose-900">
          ...
          <div className="bg-amber-50 border border-amber-200 p-4 rounded-xl space-y-2">
            <h4 className="font-bold text-xs text-amber-950">Recognizing Dehydration</h4>
            <p className="text-[11px] text-stone-600 font-semibold">Dehydration can develop quickly — especially in young puppies/kittens or any animal that has been vomiting or has diarrhea.</p>
            <ul className="space-y-1.5 text-[11px] text-stone-600 font-semibold">
            ...
            <div className="bg-rose-50 border border-rose-200 p-2 rounded-lg text-[11px] font-semibold text-rose-900">
          ...
          <div className="bg-slate-50 border p-4 rounded-xl space-y-2">
            <h4 className="font-bold text-xs text-slate-800">Signs of Pain in Dogs & Cats</h4>
            <p className="text-[11px] text-stone-500 font-semibold">Animals cannot tell you they are in pain. Watch for these behavioral and physical signs:</p>
            <ul className="space-y-1.5 text-[11px] text-stone-600 font-semibold">
              {[
            ...
            <p className="text-[10px] font-semibold text-slate-500 italic">Note: Some breeds (particularly bully breeds) have a higher pain threshold and may not vocalize even when in significant discomfort.</p>
          </div>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-3">
            <div className="p-4 bg-white border rounded-xl text-[11px] font-semibold text-stone-600 space-y-2">
              <span className="text-xl">🐜</span>
              <h5 className="font-extrabold text-slate-800 text-xs">If Fleas Are Spotted</h5>
            ...
            <div className="p-4 bg-white border rounded-xl text-[11px] font-semibold text-stone-600 space-y-2">
              ...
              <h5 className="font-extrabold text-slate-800 text-xs">If a Tick Is Found</h5>
              <ul className="space-y-1.5">
                {[
            ...
            <div className="p-4 bg-white border rounded-xl text-[11px] font-semibold text-stone-600 space-y-2">
              <span className="text-xl">🪱</span>
              <h5 className="font-extrabold text-slate-800 text-xs">Intestinal Worms</h5>
          ...
          <div className="bg-amber-50 border border-amber-200 p-4 rounded-xl text-[11px] font-semibold text-amber-900">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-3">
            <div className="p-4 bg-indigo-50/50 rounded-xl border border-indigo-100 space-y-2">
              <h5 className="text-indigo-950 font-black text-xs">The First 24 Hours</h5>
              <ul className="space-y-1.5 text-[11px] font-semibold text-stone-600">
                {[
            ...
            <div className="p-4 bg-sky-50 rounded-xl border space-y-2">
              <h5 className="text-slate-900 font-black text-xs">Incision Site Care</h5>
              <ul className="space-y-1.5 text-[11px] font-semibold text-stone-600">
                {[
            ...
            <div className="p-4 bg-amber-50 rounded-xl border border-amber-200 space-y-2">
              <h5 className="text-amber-950 font-black text-xs">Activity Restrictions (7–10 Days)</h5>
              <ul className="space-y-1.5 text-[11px] font-semibold text-stone-600">
          ...
          <div className="bg-rose-50 border border-rose-200 p-4 rounded-xl text-[11px] font-bold text-rose-950 space-y-2">
            <h5 className="text-rose-700 font-black text-xs">When to Contact Your Rescue Immediately</h5>
          ...
          <ul className="space-y-4">
            <li className="flex gap-3">
              ...
              <div>
                ...
                <ul className="mt-1 space-y-1 text-[11px] font-medium text-stone-600">
                  {[
            ...
            <li className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] font-medium text-stone-600 mt-1">Check ears weekly. Healthy ears are clean, pink, and odor-free. Contact your rescue if you notice:</p>
                <ul className="mt-1 space-y-1 text-[11px] font-medium text-stone-600">
            ...
            <li className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] font-medium text-stone-600 mt-1">Regular nail trims are important — long nails can cause difficulty walking, posture problems, and pain. If nails are clicking on the floor, they are too long. Notify your rescue coordinator to arrange a trim.</p>
                <div className="mt-2 bg-amber-50 border border-amber-200 p-2 rounded-lg text-[11px] font-semibold text-amber-900">
            ...
            <li className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] font-medium text-stone-600 mt-1">If you notice very heavy tartar buildup, broken teeth, or the animal avoiding food on one side of their mouth, let your rescue know.</p>
              </div>
            </li>
          </ul>

          <div className="bg-slate-50 border p-4 rounded-xl space-y-2">
            <h4 className="font-bold text-xs text-slate-800">Disinfecting Your Foster Space</h4>
            <ul className="space-y-1.5 text-[11px] text-stone-600 font-medium">
              {[
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-amber-50 p-4 rounded-2xl border border-amber-200">
            <h4 className="font-bold text-xs text-amber-950 mb-2 flex items-center gap-1">
            ...
            <ul className="mt-2 space-y-1.5 text-[11px] text-stone-600 font-semibold">
              {[
          ...
          <div className="p-4 border rounded-xl bg-slate-50 space-y-2">
            <h4 className="font-bold text-xs text-slate-800">Around Other Animals</h4>
            <ul className="space-y-1.5 text-[11px] text-stone-600 font-semibold">
              {[
          ...
          <div className="space-y-3">
            <h4 className="font-bold text-xs text-slate-800">Household Hazards — Room by Room</h4>
            <div className="grid grid-cols-1 gap-3">
              <div className="p-3 border rounded-xl bg-white space-y-1.5 text-[11px] font-semibold text-stone-600">
                <h5 className="font-black text-slate-800 text-xs">Kitchen, Bathroom & Utility Areas</h5>
                {[
              ...
              <div className="p-3 border rounded-xl bg-white space-y-1.5 text-[11px] font-semibold text-stone-600">
                <h5 className="font-black text-slate-800 text-xs">Living Areas</h5>
                {[
              ...
              <div className="p-3 border rounded-xl bg-white space-y-1.5 text-[11px] font-semibold text-stone-600">
                <h5 className="font-black text-slate-800 text-xs">Toy Safety</h5>
                {[
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="bg-slate-50 border p-4 rounded-xl space-y-2">
            <h4 className="font-bold text-xs text-slate-800">Video Tips</h4>
            <ul className="space-y-1.5 text-[11px] text-stone-600 font-semibold">
              {[
          ...
          <div className="bg-indigo-50 border border-indigo-100 p-4 rounded-xl space-y-2">
            ...
            <div className="bg-white/80 border border-indigo-200 p-3 rounded-xl text-[11px] font-semibold text-indigo-900">
          ...
          <div className="bg-rose-50 border border-rose-100 p-4 rounded-xl space-y-2">
            <h4 className="font-bold text-xs text-rose-950">Share on Social Media</h4>
            <ul className="space-y-1.5 text-[11px] text-stone-600 font-semibold">
              {[
          ...
          <div className="bg-amber-50 border border-amber-200 p-4 rounded-xl space-y-2">
            <h4 className="font-bold text-xs text-amber-950">Attend Adoption Events</h4>
            <p className="text-[11px] font-semibold text-stone-600 leading-relaxed">
        ...
        <div className="space-y-4">
          {[
            ...
            <div key={i} className={`space-y-1 ${i > 0 ? 'border-t pt-4' : ''}`}>
              <h5 className="font-extrabold text-indigo-700 text-xs">Q: {q}</h5>
              <p className="text-[11px] text-stone-600 leading-relaxed font-medium">{a}</p>
            </div>
          ))}

          <div className="bg-emerald-50 border border-emerald-200 p-4 rounded-xl text-[11px] font-semibold text-emerald-900">
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-rose-50 border-2 border-rose-300 p-5 rounded-2xl space-y-3">
            ...
            <ul className="space-y-2 text-[11px] text-rose-950 font-semibold">
              {[
          ...
          <div className="bg-slate-50 border p-5 rounded-2xl space-y-3">
            <h4 className="font-black text-slate-800 text-sm">Your Rescue Contact Information</h4>
            <p className="text-[11px] text-stone-500 font-semibold">Fill in this section with your rescue organization's specific contact information and post it somewhere visible in your home.</p>
          ...
          <div className="bg-emerald-50 border border-emerald-200 p-4 rounded-xl text-xs font-semibold text-emerald-950">
          ...
          <div className="text-center py-4 border-t border-sky-100">
            <p className="text-sm font-black text-slate-700">Thank you for fostering.</p>
            <p className="text-xs font-medium text-stone-500 mt-1">Every animal that passes through your home carries your kindness forward.<br/>The love you give them teaches them to trust again.</p>
            <p className="text-[10px] font-bold text-indigo-500 mt-2 uppercase tracking-wider">🐾 RescueKit — Free tools for the rescue community 🐾</p>
          </div>
        </div>
      ),
    },
    ...
    <div id="foster-guide-dashboard" className="w-full bg-white border border-sky-100 rounded-2xl md:rounded-3xl p-6 shadow-sm font-sans">
      ...
      <div className="no-print bg-gradient-to-r from-sky-50/40 to-indigo-50/20 p-6 rounded-2xl border border-sky-100 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        <div>
          ...
          <p className="text-xs text-slate-500 font-bold mt-1">A complete handbook for foster families</p>
        </div>
        <div className="hidden md:block text-right bg-white/80 p-2.5 px-4 rounded-2xl border border-sky-100 shrink-0">
          <span className="text-[10px] font-black text-emerald-600 block">15 chapters · Prepare, learn & decompress 🏡❤️</span>
          <span className="text-[9px] font-semibold text-slate-400 block mt-0.5">Offline-ready support resource</span>
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-1.5 shrink-0 bg-sky-50/50 p-1 rounded-2xl border border-sky-100 mb-6">
        {([
          ...
          <button
            ...
            className={`cursor-pointer px-3.5 py-1.5 text-xs font-extrabold rounded-xl transition-all ${activeTab === tab ? 'bg-indigo-600 text-white shadow-xs' : 'text-slate-600 hover:text-slate-900'}`}
          >
            {label}
          </button>
        ))}
      ...
      {activeTab === 'content' && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-4 hidden lg:flex flex-col gap-3">
            <div className="space-y-1.5 border-r border-sky-50/80 pr-2 max-h-[520px] overflow-y-auto">
            ...
            >
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-[9px] font-semibold opacity-75 mt-0.5 leading-none">Get the whole handbook as a PDF</p>
                </div>
              </div>
          ...
          <div className="block lg:hidden w-full mb-2">
            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-1">Select Guide Chapter</label>
            <select
          ...
          <div className="lg:col-span-8 bg-sky-50/20 border border-sky-100 rounded-2xl p-6 min-h-[460px] relative">
            ...
            <div className="flex justify-between items-center border-t border-sky-100 pt-4 mt-8">
              ...
              <span className="text-[10px] font-semibold text-slate-400">{currentChapter + 1} / {chapters.length}</span>
              <button
                type="button"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {filteredFoods.map((f, i) => (
              <div key={i} className="p-3.5 border border-purple-100 bg-white rounded-xl shadow-2xs flex gap-3">
                ...
                <div>
                  <h4 className="font-extrabold text-slate-900 text-xs">{f.name}</h4>
                  <p className="text-[10px] text-stone-500 font-bold mt-1 leading-normal">{f.effect}</p>
                </div>
              </div>
            ))}
            {filteredFoods.length === 0 && (
              <div className="col-span-full py-8 text-center text-slate-400 font-semibold text-xs space-y-1">
                <span>⚠️ No exact matches found.</span>
                <p className="text-[11px] text-stone-500">When in doubt, never feed table scraps or human food to a foster animal.</p>
              </div>
            )}
          </div>
        </div>
              ...
              <div className="grid grid-cols-3 gap-2">
                {([
                  ...
                  <button
                    ...
                    className={`cursor-pointer px-3 py-2 text-[10px] rounded-xl font-extrabold border transition-all ${tempSpecies === val ? 'bg-slate-900 text-white border-slate-950 shadow-xs' : 'bg-white text-stone-700 border-sky-100 hover:bg-sky-50'}`}
                  >
                    {label}
                  </button>
                ))}
      ...
      <div className="hidden print:block bg-white text-slate-800 p-6 font-sans leading-relaxed text-xs">
        <div className="text-center border-b-2 border-slate-300 pb-5 mb-8">
          ...
          <p className="text-xs font-bold text-slate-500 mt-2 uppercase">A Complete Handbook for Foster Families</p>
        ...
        <div className="space-y-8">
          {chapters.map((ch, idx) => (
            <div key={idx} className="print:break-inside-avoid border-b border-stone-150 pb-6 mb-6 last:border-0 last:pb-0 last:mb-0">
              ...
              <div className="text-[11px] text-slate-700 space-y-3 text-left">
                {ch.content}
              </div>
            </div>
          ))}
        ...
        <div className="text-center border-t border-stone-200 pt-6 mt-10">
          ...
          <span className="text-[9px] text-stone-400 block mt-1">🐾 RescueKit Community Hub</span>
        </div>
      </div>
